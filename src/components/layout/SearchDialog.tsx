...
const searchItems: SearchItem[] = [
  ...
  {
    title: "Setup Guide",
    description: "Complete setup walkthrough for MediaSync.",
  ...
  {
    title: "Local Video",
    description: "Manage and play your local video files.",
  ...
  {
    title: "Local Audio",
    description: "Sync local audio files across devices.",
    href: "/docs/features/local-audio",
